...
# Phase 3.5: ollama/batch 子路由（同 prefix 挂载）
from api.comfyui_batch import router as comfyui_batch_router
from api.comfyui_ollama import router as comfyui_ollama_router

router.include_router(comfyui_ollama_router)
router.include_router(comfyui_batch_router)
