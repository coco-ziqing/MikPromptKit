...
App.uc._render = function() {
    ...
    var h = '';
    h += '<div class="page-header"><h2>🎯 生图组装器</h2><span class="count-info">场景 + 角色 + 镜头 三合一画布</span></div>';
...
App.uc._renderAtomSuggestions = function(af) {
    ...
    af.merged_atoms.slice(0, 10).forEach(function(a) {
        ...
        h += '<span class="uc-atom-tag" data-text="' + App._escape(a.atom_text) +
            ...
            'transition:all .15s;" ' +
            'onmouseover="this.style.background=\'rgba(99,102,241,0.18)\';this.style.borderColor=\'#6366f1\';this.style.color=\'var(--text-main)\'" ' +
